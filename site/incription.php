...
if ($_POST) {
    ...
    if (!$verif_caractere && (strlen($_POST['pseudo']) < 1 || strlen($_POST['pseudo']) > 20)) // 
    {
        ...
        if ($membre->num_rows > 0) {
            ...
            executeRequete("INSERT INTO membre (pseudo, mdp, nom, prenom, email, civilite, ville, code_postal, adresse) VALUES ('$_POST[pseudo]', '$_POST[mdp]', 
...
<form method="post" action="">
    ...
    <input name="civilite" value="m" type="radio">mixte<br><br>

    <label for="ville">Ville</label><br>
    <input type="text" id="ville" name="ville" placeholder="votre ville" pattern="[a-z] [Z-A] [0-9]{5,15}" title="caractères acceptés : a-z-A-Z-0-9-_."><br><br>
